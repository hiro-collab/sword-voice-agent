...
_DECISION_SYSTEM_PROMPT = (
    ...
    "matches, return kind capability with that exact id. For a zero-argument constraint, "
    "satisfy the wire schema by returning position, strength, and durationMs all as null; "
    "do not invent non-null argument values. The normalizer will project those null wire "
    "values to the constrained semantic empty arguments. Do not answer with a capability "
    "refusal merely because downstream delivery is not yet proven. "
