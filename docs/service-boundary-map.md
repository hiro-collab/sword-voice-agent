...
|---|---|---|---|---|
| `control-plane-core` | `app` | `control-plane/core/` | `turn`, `events`, `expression`, `reflex`, `memory`, `access-control` | `ai-talk-core`, `aituber-kit`, `tts-service`, `thought-core` client |
...
| `thought-core` | `turn` | `control-plane/core/services/thought-core/` | `turn`, `events`, `tools`, `memory`, `access-control` | OpenAI-compatible LLM, internal provider candidates, environment/home-control clients |
