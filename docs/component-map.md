...
| `<workspace>/sword-voice-agent/services/thought-core/` | Experimental turn API and event stream | `services/thought-core` | Current canonical implementation of thought-core. |
...
implementation of the thought-core experiment. The root
